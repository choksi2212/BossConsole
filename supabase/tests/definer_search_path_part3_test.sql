...
-- Place hostile_part3 FIRST so unqualified references in unpinned functions resolve to it,
-- while retaining extensions so pgTAP functions remain resolvable.
set search_path to hostile_part3, public, extensions;
